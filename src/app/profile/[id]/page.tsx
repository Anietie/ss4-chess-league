                ...
                {standings.map((s: any) => (
                  ...
                  >
                    <td className="px-4 py-3 text-chalk">
                      {s.season?.name ?? `S${s.season}`}
                    </td>
                    <td className="px-4 py-3 text-ink-300 capitalize">
                      {s.league?.replace("_", " ")} · {s.tier}
                    </td>
                  ...
                  {repertoire.white.map((op: any) => (
                    ...
                    >
                      ...
                      <div className="flex gap-2 text-xs tabular-nums">
                        <span className="text-ink-400 w-6 text-right">
                          {op.count}G
                        </span>
                        <span className="text-green-400 w-6 text-right">
                          {op.wins}W
                        </span>
                        <span className="text-chalk-700 w-6 text-right">
                          {op.draws}D
                        </span>
                        <span className="text-red-400 w-6 text-right">
                          {op.losses}L
                        </span>
                      </div>
                    </div>
