    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-ink-400 mt-0.5">
            {opening && <span className="text-orange-400 mr-2">{opening}</span>}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-5">
        ...
        <div className="space-y-2.5">
          ...
          {/* Nav controls — single-click only, no double-fire */}
              ...
              <div key={side}>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <div className="text-right">
                    {before != null && (
                      <div className="text-xs font-mono text-orange-400">{Math.round(before)}{after != null && (
                ...
                <div key={pairIdx} className="flex gap-1 items-center">
                  ...
                  {pair.map((m) => {
                    ...
                    return (
                      ...
                      >
                        <span className={isActive ? 'text-orange-400' : 'text-chalk-700 hover:text-chalk'}>
                          {m.san}
                        </span>
